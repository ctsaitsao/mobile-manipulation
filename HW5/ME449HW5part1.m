...
thetalist = [0; 0; 0; 0; 0; 0];   % robot starts at home position
...
dt = 1/100;  % 100 integration steps per second

path = zeros(300,6);  % 300 entries (3 seconds) with each ROW being a time step's joint angles (doesn't work for columns for some reason)

for i = 1:300  % 300 entries (3 seconds)
...
csvwrite('ME499HW5part1.csv', path);  % writing into a csv file that can be read by V-REP